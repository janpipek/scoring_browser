...
class SliceTab(QtGui.QWidget):
    ...
    def initialize_ui(self):
        ...
        self.relativeCheckBox.stateChanged.connect(
            self.on_relative_checkbox_changed)
        self.sliceIndexSlider.valueChanged.connect(
    ...
    def update_slider(self):
        if self.matrix:
            ...
            self.sliceIndexLabel.setText(self.slice.axis_name
